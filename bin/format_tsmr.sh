...
export MR_PIPELINE_FORMAT_EAF_THRESHOLD="${FORMAT_TSMR_EAF_THRESHOLD:-}"

mkdir -p "${MR_PIPELINE_STANDARDIZED_OUTPUT_DIR}" "${MR_PIPELINE_EXP_DIR}" "${MR_PIPELINE_OUT_DIR}"

python "${PROJECT_DIR}/scripts/format_tsmr.py" "$@"
